...
import j2me.java.util.Collection;
import j2me.java.util.Iterator;
import j2me.java.util.List;
import j2me.java.util.ListIterator;
import j2me.java.util.RandomAccess;
...
/*
    private void readObject(ObjectInputStream stream) throws IOException,
        ...
        _low = (Object[]) new Object[_capacity];
        _high = (Object[][]) new Object[1][];
        _high[0] = _low;
        for (int i = 0; i < size; i++) {
            addLast((Object) stream.readObject());
        }
    }
